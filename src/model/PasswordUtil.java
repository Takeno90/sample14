...
public class PasswordUtil {
	...
	public String getSafetyPassword(String password,String salt) {
		...
		byte[] hashedSalt = getHathedSalt(salt);

		PBEKeySpec keySpec = new PBEKeySpec(passCharArray,hashedSalt,ITERATION_COUNT,KEY_LENGTH);
     ...
     */
	private static byte[] getHathedSalt(String salt) {
